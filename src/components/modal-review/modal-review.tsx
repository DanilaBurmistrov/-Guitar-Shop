    ...
    <div className="modal is-active modal--review modal-for-ui-kit">
      <div className="modal__wrapper">
        ...
        <div className="modal__content">
          ...
          <button className="modal__close-btn button-cross" data-testid="close" type="button" aria-label="Закрыть" onClick={() => setIsFormModalOpened(false)}><span className="button-cross__icon" ref={lastAutofocusRef} tabIndex={8}></span><span className="modal__close-btn-interactive-area"></span>
          </button>
